...
--
-- Host: localhost    Database: memcache
-- ------------------------------------------------------
...
CREATE TABLE `stats` (
  ...
  `cacheSize` float DEFAULT NULL,
  `itemCount` int DEFAULT NULL,
  `numberRequests` int DEFAULT NULL,
  `missRate` float DEFAULT NULL,
...
-- Dump completed on 2022-10-16 16:25:02
